...
int main(){
  ...
  66:	89e50513          	addi	a0,a0,-1890 # 900 <malloc+0xe6>
  6a:	00000097          	auipc	ra,0x0
  6e:	6f8080e7          	jalr	1784(ra) # 762 <printf>
			exit(1);
  72:	4505                	li	a0,1
  ...
  8a:	89250513          	addi	a0,a0,-1902 # 918 <malloc+0xfe>
  8e:	00000097          	auipc	ra,0x0
  92:	6d4080e7          	jalr	1748(ra) # 762 <printf>
		//子进程向pipe2的写端，写入字符数组
  ...
  b2:	88250513          	addi	a0,a0,-1918 # 930 <malloc+0x116>
  b6:	00000097          	auipc	ra,0x0
  ba:	6ac080e7          	jalr	1708(ra) # 762 <printf>
			exit(1);
  be:	4505                	li	a0,1
 ...
 106:	84650513          	addi	a0,a0,-1978 # 948 <malloc+0x12e>
 10a:	00000097          	auipc	ra,0x0
 10e:	658080e7          	jalr	1624(ra) # 762 <printf>
		exit(1);
 112:	4505                	li	a0,1
 ...
 138:	82c50513          	addi	a0,a0,-2004 # 960 <malloc+0x146>
 ...
 15c:	82050513          	addi	a0,a0,-2016 # 978 <malloc+0x15e>
 160:	00000097          	auipc	ra,0x0
 164:	602080e7          	jalr	1538(ra) # 762 <printf>
    //等待进程子退出
    wait(0);
 168:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4d0:	52450513          	addi	a0,a0,1316 # 9f0 <digits>
 4d4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 590:	40cc8c93          	addi	s9,s9,1036 # 998 <malloc+0x17e>
 ...
 59e:	456b8b93          	addi	s7,s7,1110 # 9f0 <digits>
 ...
 6c4:	2d098993          	addi	s3,s3,720 # 990 <malloc+0x176>
        while(*s != 0){
 6c8:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 7a6:	2667b783          	ld	a5,614(a5) # a08 <freep>
 ...
 7ce:	00e6ea63          	bltu	a3,a4,7e2 <free+0x4a>
{
 ...
 810:	1ef73e23          	sd	a5,508(a4) # a08 <freep>
}
 814:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 842:	1ca53503          	ld	a0,458(a0) # a08 <freep>
 ...
 86a:	1a290913          	addi	s2,s2,418 # a08 <freep>
  if(p == (char*)-1)
 86e:	5afd                	li	s5,-1
 870:	a895                	j	8e4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 872:	00000797          	auipc	a5,0x0
 876:	19e78793          	addi	a5,a5,414 # a10 <base>
 87a:	00000717          	auipc	a4,0x0
 87e:	18f73723          	sd	a5,398(a4) # a08 <freep>
 882:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
